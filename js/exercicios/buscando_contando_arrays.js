...
console.log("São no total ", TotalCategories, " categorias.")
...
function TotalbooksAugustoCury (){
let books = []
    for(let category of booksByCategory){
...
TotalbooksAugustoCury()

function Totalbooksauthor (author){
    let books = []
        for(let category of booksByCategory){
            for(book of category.books)
    ...
    Totalbooksauthor("Stephen R. Covey")